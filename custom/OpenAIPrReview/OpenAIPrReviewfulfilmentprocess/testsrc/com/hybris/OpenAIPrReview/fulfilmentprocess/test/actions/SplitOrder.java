 ...
 */
package com.hybris.OpenAIPrReview.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(OpenAIPrReviewFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(OpenAIPrReviewFulfilmentProcessConstants.PARENT_PROCESS);
