 ...
 */
package com.hybris.OpenAIPrReview.fulfilmentprocess.test.actions.consignmentfulfilment;
...
public abstract class AbstractTestConsActionTemp extends TestActionTemp
{
	...
	{
		final String parentCode = (String) getProcessParameterValue(process, OpenAIPrReviewFulfilmentProcessConstants.PARENT_PROCESS);
