 ...
 */
package com.hybris.OpenAIPrReview.fulfilmentprocess.strategy.impl;
...
{
	private static final Logger LOG = LoggerFactory.getLogger(SplitByWarehouse.class);
	...
	protected WarehouseModel chooseBestWarehouse(final OrderEntryGroup orderEntries)
	{
		...
		{
			LOG.error("Choose best warehouse failed!!", e);
			return null;
		}
