 ...
 */
package com.hybris.OpenAIPrReview.test.setup;
...
import com.hybris.OpenAIPrReview.test.constants.OpenAIPrReviewTestConstants;
import com.hybris.OpenAIPrReview.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = OpenAIPrReviewTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/OpenAIPrReviewtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/OpenAIPrReviewtest/import/reviews.impex");

			LOG.info("Creating Test Payment Subscriptions...");
			getAcceleratorTestOrderData().createPaymentInfos();

			LOG.info("Creating CS Tickets...");
			importImpexFile(context, "/OpenAIPrReviewtest/import/cstickets.impex");
			...
			importImpexFile(context, "/OpenAIPrReviewtest/import/csquotes.impex");
		}
	}
}
