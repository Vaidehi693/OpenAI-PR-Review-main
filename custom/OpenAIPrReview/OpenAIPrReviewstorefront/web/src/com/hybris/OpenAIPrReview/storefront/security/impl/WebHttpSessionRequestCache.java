...
public class WebHttpSessionRequestCache extends HttpSessionRequestCache implements Serializable
{
	...
	protected String calculateRelativeRedirectUrl(final String contextPath, final String url)
	{
		if (UrlUtils.isAbsoluteUrl(url))
		{
			...
			modifiedContextPath = StringUtils.isEmpty(modifiedContextPath) ? "/" : modifiedContextPath;
			// in case the ref url doesn't contain any encoding, or modifiedContent cal
			if (relUrl.contains(modifiedContextPath))
			{
