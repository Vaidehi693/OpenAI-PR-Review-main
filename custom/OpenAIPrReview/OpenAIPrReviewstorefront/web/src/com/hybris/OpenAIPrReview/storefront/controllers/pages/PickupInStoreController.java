...
import com.hybris.OpenAIPrReview.storefront.security.cookie.CustomerLocationCookieGenerator;
...
public class PickupInStoreController extends AbstractSearchPageController
{
			...
			final BindingResult bindingErrors)
	{
		...
		catch (final CommerceCartModificationException ex)
		{
			...
			LOG.warn("Couldn't add product of code " + Sanitizer.sanitize(code) + " to cart.", ex);
		}
