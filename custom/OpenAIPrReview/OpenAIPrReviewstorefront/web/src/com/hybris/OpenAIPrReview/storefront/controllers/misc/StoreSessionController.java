...
import com.hybris.OpenAIPrReview.storefront.filters.StorefrontFilter;
...
public class StoreSessionController extends AbstractController
{
			...
			final HttpServletRequest request)
	{
		...
		else
		{
			...
			{
				LOG.warn("Unknown UiExperience level [" + Sanitizer.sanitize(uiExperienceLevelString) + "] available values are: "
						+ Sanitizer.sanitize(Arrays.toString(getAvailableUiExperienceLevelsCodes())));
			}
			else
			{
